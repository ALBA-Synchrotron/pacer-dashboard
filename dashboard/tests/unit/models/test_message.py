...
class MessageLoggingTestCase(GenericTestCase):
    ...
    def test_log_message(self) -> None:
        ...
        log_pacer_message(
            ...
            self.mandatory_fields_json.get("processing_start"),
            self.mandatory_fields_json.get("processing_end"),
            ...
            self.mandatory_fields_json.get("exchange_name"),
            self.mandatory_fields_json.get("routing_key")
        )
        ...
        self.assertEqual(obj.error_message, json.dumps(self.mandatory_fields_json.get("error_message")))
